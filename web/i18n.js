...
const TRANSLATIONS = {
  tr: {
    ...
    guide_sec_sheets_desc: 'Stok sekmesindeki "Sheets" butonuna basarak Google tablonuzdaki tüm ilaç ve fiyat listesini tek tıkla uygulamaya aktarın. Senkronizasyon için kısa bir sponsorlu video izlenir.',
  ...
  en: {
    ...
    guide_sec_calc_desc: 'Switch between Treatment (hidden costs, clean total) and Quote (itemized breakdown) modes. Enter distance in KM to automatically calculate travel fees.',
    guide_sec_sheets_title: '2. Google Sheets Inventory Sync',
    guide_sec_sheets_desc: 'Tap the "Sheets" button in the Stock tab to import your medications and prices directly from Google Sheets. Watching a short video ad unlocks synchronization.',
    guide_sec_receipt_title: '3. WhatsApp Visual Receipt (JPG Slip)',
    guide_sec_receipt_desc: 'Tap "Share Visual Receipt (JPG)" to generate a high-resolution slip with clinic and IBAN details, and send directly to your client via WhatsApp.',
